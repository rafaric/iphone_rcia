...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-around h-[153px] dark:bg-dark-gray ">
      ...
      <ul
        className={`${showMenu ? "flex" : "hidden"} sm:flex gap-2 flex-1 justify-center font-semibold text-lg text-dark-gray flex-col sm:flex-row absolute sm:relative top-[140px] sm:top-0 left-0 w-full sm:w-auto bg-white sm:bg-transparent dark:bg-dark-gray z-10 p-4 sm:p-0`}
      >
